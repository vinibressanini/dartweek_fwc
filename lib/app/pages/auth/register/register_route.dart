...
import 'package:dartweek_fwc/app/pages/auth/register/presenter/register_presenter_impl.dart';
...
class RegisterRoute extends FlutterGetItPageRoute {
  ...
  List<Bind<Object>> get bindings => [
    Bind.lazySingleton<RegisterPresenter>((i) => RegisterPresenterImpl(repository: i()))
  ];
